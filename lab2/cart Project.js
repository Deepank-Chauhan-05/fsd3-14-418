...
const removeProduct = async (pid) => {
    ...
    if (x > y) {
        ...
        console.log(`Product with id $(pid) is in the cart`);
    }
}

const updateQuantity = async (pid1) => {
    const cart = await getCart();
    const isFoundInCart = cart.find((item) => item.id === pid1);
    ...
    if (isFoundInCart) {
        ...
        console.log(`Product with id $(pid1) is not found`);
    }
}
    ...
    do {
        ...
        switch (Number(choice)) {
            ...
            case 3:
                ...
                break;
            case 4:
                let pid1 = await cin.question("Enter product id: ");
                await updateQuantity(Number(pid1));
                break;
            case 5:
